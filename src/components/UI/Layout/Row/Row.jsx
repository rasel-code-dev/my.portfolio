...
const Row = (props) => {
  ...
  const { spacing, className, direction, textAlign, justify, alignItems, style, bg, color, m, mt, mb, ml, mr, mx, my, p, pt, pb, pl, pr, py, px, waves, children, ...attributes} = props
  ...
  const jsStyles = styles({justify, alignItems, style, bg, color, m, mt, mb, ml, mr, mx, my, p, pt, pb, pl, pr, py, px});
  ...
  return (
    <div data-test="row" className={classes} style={jsStyles}>
