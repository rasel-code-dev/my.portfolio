...
const BlogSection = (props) => {
  ...
  return (
    <section className="section" id="blog-section" data-role="blog">
      <div className="container">
        <div className="row-b mt-4">
          <h1 className="section-title">Blog</h1>
          <h6 className="sub-title text-center">My Latest Blog Posts</h6>
        </div>
                  ...
                  <div className="row">
                    <div className={classes['post-header']}>
                      <div className={classes['post-avatar']}>
                        <img src={fullLink(props.state.profile_photo)} alt="rasel-code-dev"/>
                      </div>
        ...
        <div className={classes.hire_me}>
            <div className={classes.card + " card text-center"}>
              <h1>Now I am ready to start work for you!</h1>
              <div className="flex justify-center">
                <Button
                  href="#contact-section"
                  outline={true}
                  prefixIcon={<span className="df"> <FontAwesomeIcon icon={faBadgeCheck} /> </span>}>
                  Hire me!
                </Button>
              </div>
            </div>
