...
import {fullLink} from "../../utilities/fullLink";

import user_circle from  "src/asserts/icons/analytics.svg"
import angleUpIcon from  "src/asserts/icons/angle-up.svg"
    ...
    <div className={classes.navigation}>
      ...
      <div className="container">
        <div className={classes["nav-container"]}>
          <nav className={[classes.navbar, "align-items-center", setBreakPoint() ].join(" ")}>
