...
const ContactSection = (props) => {
  ...
  return (
    <section className="section" id="contact-section" ref={contactSection}>
      {
        isSendMessage &&
      ...
      <div className="container">
        <div className="row-b mt-20">
          ...
          <h6 className="sub-title t-center ">GET IN TOUCH</h6>
          <div className="row-b mt-3">
            {/*{ sendMessage.message !== "" && <h5 className={["popup-message t-center", sendMessage.success ? "success" : "error"].join(" ")}>{sendMessage.message}</h5> }*/}
          </div>
          
        </div>
  
        <div className={"row-b  mt-5 " + classes["contact-form-wrapper-row"] }>
          <Row>
            <Col sm={12} md={4} lg={4} xl={3}>
              <div className={"col mr-2 " + classes["social-contact"]}>
              ...
              <div className={classes["social-contact__item"]}>
                ...
                <div>
                  ...
                  <div className="social">
                    <a target="_blank" href={social_links?.twitter} className="social-icon twitter"  > <i className="fab fa-twitter" /></a>
                    <a target="_blank" href={social_links?.facebook} className="social-icon facebook"><i className="fab fa-facebook-f" /> </a>
                    <a target="_blank" href={social_links?.github} className="social-icon github"><i className="fab fa-github" /> </a>
                    <a target="_blank" href={social_links?.instagram} className="social-icon instagram"><i className="fab fa-instagram" /></a>
                    <a target="_blank" href={social_links?.google} className="social-icon google-plus"><i className="fab fa-google-plus-g" /> </a>
                  </div>
                </div>
              </div>
        ...
        <div className={"card-2 " + classes["visitor-row--wrapper"]}>
          <h1 className={"t-center " + classes["visitor-text"]}>Visitors</h1>
  
          <div className={"row-f " + classes["visitor-row"]}>
